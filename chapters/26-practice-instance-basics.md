...
- 作業ブランチ `feature/26-practice-instance-basics` で作業し、PRで提出できる
...
- [ ] `feature/26-practice-instance-basics` で作業し、コミットしてpushした
- [ ] `feature/26-practice-instance-basics` → `develop` のPRを作成した
