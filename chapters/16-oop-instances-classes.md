...
- 作業ブランチ `feature/16-oop-instances-classes` で作業し、PRで提出できる
...
- [ ] `feature/16-oop-instances-classes` で作業し、コミットしてpushした
- [ ] `feature/16-oop-instances-classes` → `develop` のPRを作成した
...
1. 上記の練習問題を完了する
2. GitHub で `feature/16-oop-instances-classes` ブランチを作成し、PRを作成
